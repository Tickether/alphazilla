...
contract MerkleDistributor {
    ...
    modifier tokensAvailable(
        ...
        require(claimed + mintAmount <= totalTokenAmount, 'exceed max per wallet');
        _;
    }
     ...
     */
    function _setAllowListMinted(address to, uint256 mintAmount) internal virtual {
        _allowListNumMinted[to] += mintAmount;

        emit Claimed(to, mintAmount);
    }
